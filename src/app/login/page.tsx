        ...
        <div className="relative overflow-hidden rounded-2xl bg-white p-10 shadow-xl dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mb-8 text-center text-sm text-gray-500 dark:text-gray-400">
              Sign in to proceed to your bookmarks
            </p>
          </div>
          <form action={signIn} className="mt-8 space-y-6">
            <button
              type="submit"
              className="group relative flex w-full justify-center items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition-all  hover:shadow-md focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-offset-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-750 dark:hover:border-gray-600"
            >
               {/* Google Logo SVG */}
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" className="w-5 h-5">
